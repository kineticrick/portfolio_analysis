...
asset_types_table_df['id'] = asset_types_table_df['Asset Type']
...
row_asset_type_mapping = {row: asset_type
                      for row, asset_type
                      in enumerate(asset_types_table_df['Asset Type'])}
...
def update_asset_types_hist_graph(selected_rows, interval):
    ...
    if selected_rows:
        ...
        asset_types_history_df = asset_types_history_df[
            asset_types_history_df['Asset Type'].isin(selected_asset_types)]
    ...
    # asset_types_history_df = DASH_HANDLER.expand_history_df(asset_types_history_df, id_column="Asset Type")
    ...
    asset_types_history_fig = px.line(
        ...
        color=asset_types_history_df['Asset Type'],
        # line_dash=asset_types_history_df['Asset Type'],
    )
